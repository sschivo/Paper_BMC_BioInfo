...
\title{Building formal models of biological networks avoiding formal training}
...
This case study will also be used to evaulate the improvement in performances introduced
by the new version of ANIMO, which is described in the Methods section.


\subsubsection*{Simulation-based analysis}
We start by evaluating the cost in terms of time of simulations. This is a particularly
important aspect to consider, as during the model building phase a user may need to perform a relatively
...
the new one introduced in ANIMO 2. We will compare the execution times and memory requirements for a number of interesting queries:
\begin{itemize}
